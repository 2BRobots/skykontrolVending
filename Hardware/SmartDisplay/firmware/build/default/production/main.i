...
# 52 "C:\Program Files (x86)\Microchip\xc8\v2.10\pic\include\pic12f1822.h"
...
{
I2C_buffer.data.ID = 0x01;
I2C_buffer.data.TIMEOUT = 20000;
I2C_buffer.data.BEEP = 250;
...
PWM_set_duty(I2C_buffer.data.BRIGHTNESS);
if (I2C_buffer.data.BEEP > 0)
{
LATAbits.LATA0 = 1;
